...
void main() {
  group('Malformed Input Tests', () {
    ...
    testDecoder('PNG invalid header', PngDecoder(), Uint8List.fromList([0x00, 0x00, 0x00, 0x00]));
    testDecoder('JPEG', JpegDecoder(), Uint8List(0));
    testDecoder('JPEG invalid header', JpegDecoder(), Uint8List.fromList([0x00, 0x00]));
    ...
    testDecoder('PNG truncated', PngDecoder(), Uint8List.fromList([0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A]));
  });
}