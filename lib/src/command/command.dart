...
class Command {
  ...
  void chromaticAberration({
    ...
    subCommand = ChromaticAberrationCmd(
      subCommand,
      shift: shift,
      mask: mask,
      maskChannel: maskChannel,
  ...
  void copyImageChannels({
    ...
    subCommand = CopyImageChannelsCmd(
      subCommand,
      from: from,
      scaled: scaled,
      red: red,
  ...
  void luminanceThreshold({
    ...
    subCommand = LuminanceThresholdCmd(
      subCommand,
      threshold: threshold,
  ...
  void separableConvolution({
    ...
    subCommand = SeparableConvolutionCmd(
      subCommand,
      kernel: kernel,
      mask: mask,
      maskChannel: maskChannel,
  ...
  void stretchDistortion({
    ...
    subCommand = StretchDistortionCmd(
      subCommand,
      centerX: centerX,
      centerY: centerY,
      interpolation: interpolation,
  ...
  void copyResizeCropSquare({
    ...
    subCommand = CopyResizeCropSquareCmd(
      subCommand,
      size: size,
      radius: radius,
      interpolation: interpolation,
